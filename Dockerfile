...
# Install components
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get -y install sudo deluged deluge-web deluge-console runit psmisc nginx php5-fpm unzip wget php5-gd libav-tools zip imagemagick && apt-get clean && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
